...
class HgpLa1 extends StatefulWidget {
  static const String id = 'hgpla1';

  @override
  _HgpLa1State createState() => _HgpLa1State();
}

class _HgpLa1State extends State<HgpLa1>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Los Angeles Cohort 1"),
        actions: <Widget>[
