...
class HgpOak7 extends StatefulWidget {
  static const String id = 'hgpoak7';

  @override
  _HgpOak7State createState() => _HgpOak7State();
}

class _HgpOak7State extends State<HgpOak7>{
      ...
      body: Stack(
          ...
          children: <Widget>[
            ...
            Column(
              ...
              children: <Widget>[
                Container(
                  child: infoCard(context, "Oakland Cohort 7"),
                ),
              ],),
            Column(
