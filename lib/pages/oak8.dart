...
class HgpOak8 extends StatefulWidget {
  static const String id = 'hgpoak8';

  @override
  _HgpOak8State createState() => _HgpOak8State();
}

class _HgpOak8State extends State<HgpOak8>{
      ...
      body: Stack(
          ...
          children: <Widget>[
            ...
            Column(
              ...
              children: <Widget>[
                Container(
                  child: infoCard(context, "Oakland Cohort 8"),
                ),
              ],),
            Column(
