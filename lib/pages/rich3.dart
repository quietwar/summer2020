...
class HgpRich3 extends StatefulWidget {
  static const String id = 'hgprich3';

  @override
  _HgpRich3State createState() => _HgpRich3State();
}

class _HgpRich3State extends State<HgpRich3>{
