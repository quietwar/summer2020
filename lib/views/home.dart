...
//       actions: <Widget>[IconButton(icon: Icon(FontAwesomeIcons.user), onPressed: () {
//         Navigator.pushNamed(context, ChatScreen.id);
//         }),
//        ],
...
//           children: <Widget>[
//               hgpCohorts("hgpLa1", "assets/images/isiahTeaching.jpg", getGridViewSelectedItem, 0xFF02b5e0, 0xFF02cabd),
//               hgpCohorts("hgpOak7", "assets/images/allCohorts17.jpg", getGridViewSelectedItem, 0xFF965ffe, 0xFF3c8efe),
//               hgpCohorts("hgpOak8", "assets/images/malik_spiderman.jpg", getGridViewSelectedItem, 0xFF07dfaf, 0xFF47e544),
//               hgpCohorts("hgpRich3", "assets/images/Rich8.1.png", getGridViewSelectedItem, 0xFFffda00, 0xFFffa500),
//               hgpCohorts("hgpRich4", "assets/images/techslam.JPG", getGridViewSelectedItem,   0xFFffa15b, 0xFFfe6075),
//             ],
//         )
//       );
//   }
...
//   Widget hgpCohorts(String gridName, String gridImage, Function getGridViewSelectedItem, int color1, int color2,) {
//     return Container(
...
//   getGridViewSelectedItem(BuildContext context, int index){
//      GestureDetector(
//         onTap: 
